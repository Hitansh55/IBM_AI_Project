...
type OriginButtonProps = HTMLMotionProps<"button"> & {
  ...
  (
    ...
    return (
      <motion.button
        ...
        className={cn(
          "relative inline-flex h-12 cursor-pointer touch-manipulation select-none items-center justify-center overflow-hidden rounded-xl px-6 font-semibold text-[17px] tracking-[-0.01em]",
          "border border-mat-green/20 bg-cream text-mat-green shadow-sm",
          "transition-[color] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mat-green/50",
          "disabled:pointer-events-none disabled:opacity-50",
          className,
          showFill && activeTextClassName
        )}
      ...
      >
        <motion.span
          ...
          aria-hidden
          className={cn("pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full", fillClassName)}
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
