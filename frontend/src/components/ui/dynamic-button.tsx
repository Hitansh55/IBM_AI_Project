...
const buttonClasses: Record<DynamicButtonVariant, string> = {
  ...
  secondary:
    "border-neutral-200 bg-white text-neutral-950 hover:border-neutral-300 hover:bg-neutral-50 shadow-sm",
};
...
function getButtonClassName({
  ...
  return [
    "inline-flex h-8 cursor-pointer items-center justify-center gap-1.5 rounded-full border px-4 py-4 text-[0.85rem] font-medium transition-colors",
